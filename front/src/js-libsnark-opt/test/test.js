import  SnarkLib, {SnarkLibUtils} from '../src/libsnark.interface.js';
...
const snark_path        = path.resolve() + '/../libsnark/'; console.log("snark_path : ", snark_path);
...
describe('snark Test', ()=> {
    ...
    it('Verify Proof does not use cs_file', (done)=> {
        ...
        SnarkLib.buildCircuit(contextId);
        if(use_json_flag) { 
            // json 으로하면 verify될 때도 있고 안될 때도 있음. (10번 정도 안되고 1번됨)
